...
def predicates(desc: dict, growth: float, rel_drop: float = 0.0) -> list[str]:
    ...
    words.append("wounded" if wounded else "healing" if 0.0 < growth <= 0.002 and m > 0.1 else "whole")
